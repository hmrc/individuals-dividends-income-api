...
class DeleteUkDividendsIncomeAnnualSummaryValidatorSpec extends UnitSpec {
  ...
  class Test extends MockAppConfig {
    ...
    val validatorFactory                         = new DeleteUkDividendsIncomeAnnualSummaryValidatorFactory()
  ...
  "running a validation" should {
    "return no errors" when {
      "a valid request is supplied" in new Test {
        ...
        result shouldBe Right(DeleteUkDividendsIncomeAnnualSummaryRequest(Nino(validNino), TaxYear.fromMtd(validTaxYear)))
      }
    }
